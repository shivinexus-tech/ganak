...
export const HORA_COLOR = { Sun: "color-mix(in srgb, #C2451E, var(--ink) 26%)", Moon: "color-mix(in srgb, #5B7FB0, var(--ink) 26%)", Mars: "color-mix(in srgb, #B23B2E, var(--ink) 26%)", Mercury: "color-mix(in srgb, #2E8B6F, var(--ink) 26%)", Jupiter: "color-mix(in srgb, #A86A12, var(--ink) 26%)", Venus: "color-mix(in srgb, #9A5BA3, var(--ink) 26%)", Saturn: "color-mix(in srgb, #5A6470, var(--ink) 26%)" };
