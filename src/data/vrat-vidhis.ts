...
export const VRAT_VIDHI = {
  ...
  diwali: {
    ...
    regional: [
      {
        en: "North and much of western India\n\nIn Uttar Pradesh, Punjab, Rajasthan, Gujarat and the Hindi-speaking heartland, the Amavasya night is widely kept as Lakshmi Puja. Homes are cleaned and lit; rangoli or alpana may adorn the threshold; families gather for evening worship of Lakshmi, often with Ganesha first, then aarti, prasad and sweets shared among neighbours and kin.\n\nDiyas are placed at the doorway, balcony and altar — a visible sign of welcome and gratitude. Mithai, dry fruit and the family's festive meal follow local taste: peda in the North, mohanthal in Gujarat, ghevar where the season allows. Business households may worship the account book or Kubera on Dhanteras or this night; that is a respected trader's custom, not a rule every home must follow.\n\nThe mood is warmth, renewal and honest prosperity — lamps for Rama's welcome in the Ramayana memory of the region, and Lakshmi as the gracious hostess of the household.",
        hi: "उत्तर और पश्चिम भारत के बड़े भाग\n\nउत्तर प्रदेश, पंजाब, राजस्थान, गुजरात और हिन्दी-भाषी मध्य-भारत में अमावस्या-रात्रि व्यापक रूप से लक्ष्मी पूजा के रूप में मनाई जाती है। घर स्वच्छ और प्रकाशित किए जाते हैं; द्वार पर रंगोली या अल्पना; परिवार सायंकाल में लक्ष्मी की पूजा करता है, प्रायः पहले गणेश, फिर आरती, प्रसाद और मिठाई पड़ोस और कुटुम्ब में बाँटी जाती है।\n\nद्वार, बालकनी और वेदी पर दीप — स्वागत और कृतज्ञता का दृश्य प्रतीक। मिठाई, मेवा और उत्सवी भोजन क्षेत्रीय स्वाद के अनुसार: उत्तर में पेड़ा, गुजरात में मोहनथल, ऋतु अनुसार घेवर। व्यापारी घर धनतेरस या इसी रात बही-खाता या कुबेर की पूजा कर सकते हैं; यह सम्मानित व्यापारिक रीति है, हर घर के लिए अनिवार्य नियम नहीं।\n\nभाव गर्मजोशी, नवीनता और ईमानदार समृद्धि का है — इस क्षेत्र की रामायण स्मृति में राम के स्वागत के दीप, और लक्ष्मी घर की कृपामयी अधिष्ठात्री।",
      },
      {
        en: "Bengal and parts of eastern India\n\nOn the same Kartik Amavasya, countless Bengali homes honour Ma Kali as Shyama or Kali Puja. Red hibiscus, bel leaves, a clay or metal image of the Goddess, and night-long arati replace the North Indian Lakshmi thali — not as a lesser form of Diwali, but as the region's own complete Shakta celebration of the night when the Divine Mother is felt nearest.\n\nNishita or late-evening worship is common; dhunuchi dance, crackers in moderation and community pandals carry the festival into the streets. Odisha and Assam share strands of this eastern Amavasya mood while keeping their own local names and customs.\n\nA family that keeps Kali Puja should follow its Shakta timing and household steps; a family that keeps Lakshmi Puja should follow that distinct vidhi. Both belong to the same sacred night without being merged into one interchangeable ritual.",
        hi: "बंगाल और पूर्वी भारत के कुछ भाग\n\nउसी कार्तिक अमावस्या पर असंख्य बंगाली घर माँ काली की श्यामा या काली पूजा करते हैं। लाल जवा, बेलपत्र, मिट्टी या धातु की देवी-प्रतिमा और रात्रि भर की आरती उत्तर भारतीय लक्ष्मी-थाली का स्थान लेती हैं — दीपावली का कमतर रूप नहीं, बल्कि इस क्षेत्र का अपना पूर्ण शाक्त उत्सव जब दिव्य माता सबसे निकट महसूस होती है।\n\nनिशीथ या देर रात्रि की पूजा प्रचलित है; धुनुची नृत्य, संयमित पटाखे और सामुदायिक पंडाल पर्व को गलियों तक ले जाते हैं। ओडिशा और असम इस पूर्वी अमावस्या के भाव को साझा करते हुए अपने स्थानीय नाम और रीतियाँ रखते हैं।\n\nकाली पूजा मानने वाला परिवार उसका शाक्त समय और गृह-विधि अपनाए; लक्ष्मी पूजा मानने वाला परिवार उसकी अलग विधि रखे। दोनों उसी पवित्र रात्रि के अंग हैं, पर उन्हें एक ही बदलने योग्य अनुष्ठान न बनाएँ।",
      },
      {
        en: "Maharashtra and the western Deccan sequence\n\nMaharashtrian Diwali is a named sequence of days, not one interchangeable ritual. Vasubaras (Govatsa Dwadashi) honours the cow and calf; Dhantrayodashi brings Lakshmi-Kubera and Yama Deepam; Naraka Chaturdashi dawn brings abhyanga snan and chakli-karanji faral; Lakshmi Pujan fills the Amavasya evening; Bali Pratipada or Padwa opens the new year with Govardhan memory; Bhau Beej strengthens the sibling bond.\n\nEach day has its own food, greeting and puja — faral trays of karanji, chakli, shankarpali and ladoo are prepared across the five days. Early-morning oil bath, new clothes and the exchange of shodashopachara where the family already practises it give the sequence its rhythm.\n\nKeep each named day as its own observance: Dhanteras, Naraka Chaturdashi, Diwali, Govardhan and Bhai Dooj should not be folded into one generic lamp-lighting ritual.",
        hi: "महाराष्ट्र और पश्चिमी दक्कन का क्रम\n\nमहाराष्ट्रीय दीपावली नामित दिनों की श्रृंखला है, एक परिवर्तनीय अनुष्ठान नहीं। वसुबारस (गोवत्स द्वादशी) में गौ-बछड़े का सम्मान; धनत्रयोदशी पर लक्ष्मी-कुबेर और यम दीपम; नरक चतुर्दशी की भोर में अभ्यंग स्नान और चकली-करंजी फराळ; अमावस्या की संध्या में लक्ष्मी पूजन; बली प्रतिपदा या पाडवा पर गोवर्धन स्मृति से नव वर्ष; भाऊबीज से भाई-बहन का बंधन।\n\nप्रत्येक दिन का अपना भोजन, अभिवादन और पूजा — पाँच दिनों में कड़ी, चकली, शंकरपाळी और लाडू का फराळ तैयार होता है। प्रातः तेल-स्नान, नए वस्त्र और जहाँ प्रचलित हो षोडशोपचार पूजा क्रम को गति देते हैं।\n\nधनतेरस, नरक चतुर्दशी, दीपावली, गोवर्धन और भाई दूज—हर नामित दिन को अलग पर्व रखें; पूरे पखवाड़े को एक सामान्य दीप-विधि में न मिलाएँ।",
      },
      {
        en: "Tamil Deepavali and much of the South\n\nIn Tamil Nadu, Karnataka, Andhra and Telangana, Deepavali morning is the emotional centre of the festival. Before sunrise on Naraka Chaturdashi, families take the ritual oil bath — often with heated gingelly oil, turmeric and shikakai — wear new clothes, eat lehyam or festive breakfast, burst a few crackers at the auspicious hour, and only then begin visits and temple rounds.\n\nThe Krishna–Narakasura story belongs to this dawn: the victory over darkness that justifies the bath and the new day. Evening lamps still matter, but they crown a day that began with cleansing and joy at first light — not a direct copy of the North Indian Lakshmi-puja night moved a few hours earlier.\n\nAndhra and Karnataka share the abhyanga and faral customs with Maharashtra in places; Kerala's calendar relationship to the lunar fortnight differs. Follow the local city time for each named day—morning bath on Naraka Chaturdashi, then Lakshmi or local deity worship on Amavasya as your household observes.",
        hi: "तमिल दीपावली और दक्षिण का अधिकांश भाग\n\nतमिलनाडु, कर्नाटक, आंध्र और तेलंगाना में दीपावली का भावुक केंद्र प्रातःकाल है। नरक चतुर्दशी की सूर्योदय से पहले तेल-स्नान — प्रायः गर्म तिल का तेल, हल्दी और शिकाकाई — नए वस्त्र, लेह्यम या उत्सवी नाश्ता, शुभ घड़ी में कुछ पटाखे, फिर मंदिर और मिलन।\n\nकृष्ण–नरकासुर की कथा इसी भोर से जुड़ी है: अंधकार पर विजय जो स्नान और नए दिन को औचित्य देती है। सायंकाल के दीप भी महत्वपूर्ण हैं, पर दिन प्रकाश में शुद्धि और आनंद से आरंभ हुआ — उत्तर भारतीय लक्ष्मी-पूजन रात्रि का केवल कुछ घंटे पहले का रूप नहीं।\n\nआंध्र और कर्नाटक कई स्थानों पर महाराष्ट्र के साथ अभ्यंग और फराळ साझा करते हैं; केरल का पक्ष-पंचांग सम्बन्ध भिन्न हो सकता है। प्रत्येक नामित दिन का स्थानीय समय मानें—नरक चतुर्दशी पर प्रातः स्नान और अमावस्या पर कुलानुसार लक्ष्मी या स्थानीय देवी की पूजा।",
      },
    ],
    paran: {
  ...
  ayyappaMandala: {
    ...
    diet: {
      ...
      hi: "सबरीमला व्रत का मुख्य आहार-अनुशासन शाकाहार, नशामुक्ति और सरल जीवन है। भोजन-समय, प्याज-लहसुन और अन्य सामग्री के नियम भिन्न होते हैं; गुरु स्वामी, मंदिर या परिवार-समूह से मिला नियम रखें।",
    },
    sankalpa: {
...
// Keep navigation/product language outside devotional copy.
if (VRAT_VIDHI.ekadashi?.regional?.[0]) {
  VRAT_VIDHI.ekadashi.regional[0] = {
    en: "Smarta and Vaishnava observances can fall on different dates; follow the tradition selected for this calendar.",
    hi: "स्मार्त और वैष्णव एकादशी अलग तिथि पर हो सकती हैं; इस पंचांग के लिए चुनी हुई परम्परा मानें।",
  };
}

Object.assign(VRAT_VIDHI.skandaSashtiBegins, {
  udyapan: { en: "Day 1 begins the six-day vow; continue the chosen discipline through the remaining named days.", hi: "दिन 1 छह-दिवसीय व्रत आरम्भ करता है; चुना हुआ अनुशासन शेष नामित दिनों तक जारी रखें।" },
});
Object.assign(VRAT_VIDHI.skandaSashtiSoorasamharam, {
  udyapan: { en: "After the victory worship, complete the fast tonight or on day 7 exactly as the family or temple sequence teaches.", hi: "विजय-पूजन के बाद परिवार या मंदिर के क्रम के अनुसार आज रात्रि या दिन 7 पर व्रत पूर्ण करें।" },
});
Object.assign(VRAT_VIDHI.skandaSashtiThirukalyanam, {
  udyapan: { en: "Thirukalyanam and its prasad close the annual sequence for households whose vow ends on day 7.", hi: "जिन घरों का व्रत दिन 7 पर समाप्त होता है, उनके लिए तिरुकल्याणम् और प्रसाद वार्षिक क्रम पूर्ण करते हैं।" },
});
