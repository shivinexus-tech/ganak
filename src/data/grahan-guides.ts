...
export const GRAHAN_GUIDES = {
  suryaGrahan: guide({
    verdict: ["On the day of this solar grahan, if it is visible at your city Sutak applies from four prahar — about twelve hours — before the eclipse begins here, until it ends. Ganak counts real prahars (a prahar is a quarter of the daytime, or a quarter of the night), which is why the start is rarely exactly twelve hours earlier. Children, the elderly and the unwell keep one prahar, about three hours. Avoid new puja, cooking and eating during Sutak unless your lineage permits further exceptions for essential medicine.", "इस सूर्य ग्रहण के दिन, यदि आपके शहर में दिखाई दे तो ग्रहण के स्थानीय आरम्भ से चार प्रहर — लगभग बारह घंटे — पूर्व से समाप्ति तक सूतक लगता है। गणक वास्तविक प्रहर गिनता है (प्रहर दिनमान या रात्रिमान का चौथा भाग है), इसीलिए आरम्भ ठीक बारह घंटे पहले कम ही पड़ता है। बालक, वृद्ध और रोगी एक प्रहर, लगभग तीन घंटे, मानते हैं। सूतक में नया पूजन, खाना बनाना और भोजन त्यागें, जब तक परंपरा आवश्यक दवा आदि के लिए और अपवाद न दे।"],
...
नेत्र-सुरक्षा अलग भौतिक नियम है। खुले या आंशिक रूप से ढके सूर्य को सीधे देखने से बिना तत्काल पीड़ा के दृष्टिपटल को चोट लग सकती है। भक्ति, साधारण धूप-चश्मा, खुली फिल्म या जल में प्रतिबिम्ब सीधे दर्शन को सुरक्षित नहीं बनाते। प्रमाणित ग्रहण-दर्शक या अप्रत्यक्ष प्रक्षेपण विधि अपनाएँ और बच्चों की निगरानी करें। गर्भावस्था की रीतियाँ, आहार-वर्जन और सूतक धार्मिक परम्परा के विषय हैं; नेत्र-सुरक्षा तीव्र सूर्य-प्रकाश के भौतिक खतरे पर आधारित है और प्रत्येक दर्शक पर लागू होती है।`,
  ...
  chandraGrahan: guide({
    verdict: ["On the night of this lunar grahan, if it is visible at your city Sutak begins three prahar — about nine hours — before the eclipse begins here, and ends at Moksha. Ganak counts real prahars (a prahar is a quarter of the daytime, or a quarter of the night), which is why the start is rarely exactly nine hours earlier. Children, the elderly and the unwell keep one prahar, about three hours. Avoid eating and starting new sacred work during Sutak unless your lineage allows further exceptions.", "इस चंद्र ग्रहण की रात्रि, यदि आपके शहर में दिखे तो सूतक ग्रहण के स्थानीय आरम्भ से तीन प्रहर — लगभग नौ घंटे — पूर्व लगता है और मोक्ष पर समाप्त होता है। गणक वास्तविक प्रहर गिनता है (प्रहर दिनमान या रात्रिमान का चौथा भाग है), इसीलिए आरम्भ ठीक नौ घंटे पहले कम ही पड़ता है। बालक, वृद्ध और रोगी एक प्रहर, लगभग तीन घंटे, मानते हैं। सूतक में भोजन और नया पवित्र कार्य त्यागें, जब तक परंपरा और अपवाद न दे।"],
