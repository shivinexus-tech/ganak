...
// A panel whose whole purpose is user-facing transparency must not print internal ids.
const PRESET_LABEL: Record<string, { en: string; hi: string }> = {
  "simple-large": { en: "Simple & Large", hi: "सरल और बड़ा" },
  balanced: { en: "Balanced", hi: "संतुलित" },
  detailed: { en: "Detailed", hi: "विस्तृत" },
  custom: { en: "Custom", hi: "अपनी पसंद" },
};
