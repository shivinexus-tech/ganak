  ...
  return (
    <div>
      ...
      {(() => {
        ...
        const obs = observancesFor(p.krishna, p.tithiDay, p.months?.amanta || null, p.dow, p.anchor);
      ...
      {(() => {
        ...
        const obs = observancesFor(todayP.krishna, todayP.tithiDay, todayP.months?.amanta || null, todayP.dow, todayP.anchor);
