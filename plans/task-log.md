...
| P1-HIDE-DEPLOY | ACTIVE | Codex | `main` | minimal shell nav hide, hosting config, deployment docs | Hide Chart entry points and deploy Phase 1 web build | Chart wire is MERGED on `main`; Phase 1 nav hide and deployment started 2026-07-19. |
