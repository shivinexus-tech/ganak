...
| P1-HIDE-DEPLOY | BLOCKED | Codex | `main` | minimal shell nav hide, hosting config, deployment docs | Hide Chart entry points and deploy Phase 1 web build | Local hide in WT; deploy blocked (git quota + host allowlist). Cursor may commit hide with ChartScreen. |
