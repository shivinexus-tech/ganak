...
| P1-FESTIVAL-DEEPLINKS | READY — P0 BEFORE GO-LIVE | Unassigned | `main` | routing + festival guide entry UI (reserve exact files before work) | Stable, shareable URLs for four approved festival guides | Add `/festival/hartalika-teej`, `/festival/chaitra-navratri`, `/festival/sharad-navratri`, `/festival/chhath`. Preserve the existing in-app card click/expand path unchanged; compare both entry paths after launch before making any navigation decision. |
