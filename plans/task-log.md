...
| SPLIT-UI-CHART-WIRE | ACTIVE | Codex | `main` | `src/kundli-app.tsx`, listed Chart/Jyotish peel modules, task log/handoff | Import peeled Chart/Jyotish modules and delete shell copies | Sole shell writer confirmed after P1-CONTENT commit `6aca6b8`; wiring started 2026-07-19. |
