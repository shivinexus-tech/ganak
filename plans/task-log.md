...
| SPLIT-UI-03-WIRE | ACTIVE | Claude Code | `main` | `src/kundli-app.tsx` (integration-owned) | Wire Cursor's peeled Daily modules into the shell per `plans/cursor-handoff-daily-ready.md` | Cursor confirmed idle on all of `src/` (2026-07-19 ~16:37 PT). Claude owns the shell for this wire. Was previously BLOCKED on write contention. |
