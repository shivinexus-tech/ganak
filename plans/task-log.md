...
| CODEX-P1-BUNDLE | RESERVED | Codex | `main` | see `plans/codex-task-phase1-bundle.md` | Tracks 1 content → 2 Chart wire → 3 hide+deploy (sequenced) | Owner assigned 2026-07-19. |
