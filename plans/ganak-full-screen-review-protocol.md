...
| Independent Visual Art QA | Bind immutable natural-scale artifacts and one exact-membership contact sheet to every desktop node; record background, composition, ornament and rejected-resemblance judgments. | Build/reclone the reviewed nodes, self-approve, reuse evidence from predecessor nodes, or review mobile while mobile is paused. |
