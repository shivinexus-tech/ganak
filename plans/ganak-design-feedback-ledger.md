...
| ID | Class / status | Owner feedback and source | Concrete do / don't | Scope / owner |
|---|---|---|---|---|
| `GDF-012` | `GLOBAL` · `ACTIVE` | Pale blue and clean white are approved-safe bases, **not the complete or exclusive palette**. The owner rejected dull ivory/cream wash as the dominant website background, not every warm or source-derived colour. Owner clarification, 2026-08-19. | Use canvas `#F9FCFD`, surface `#FFFFFF`, secondary `#ECF4F7` when a safe base is needed. Permit evidenced source colours—navy, crimson/burgundy, luminous/antique gold, powder blue, botanical greens and others—only with a named role, relationship, contrast and density rule. Extraction alone is not approval. Review nodes `652:13737`, `652:13989`, `652:14035`, `652:14120` received only targeted dull-ivory drift correction; do not replace purposeful colour with monotonous pale blue. See `REJ-004` and board `707:14247`. | All website screens · integrator |
...
| ID | Class / status | Owner feedback and source | Concrete do / don't | Scope / owner |
|---|---|---|---|---|
| `GDF-054` | `REJECTED DIRECTION` · `CHANGES REQUESTED — DESKTOP OWNER REVIEW` | The owner explicitly rejected the minimal vertical floral edge and detached lower-right ornament used inside the current ordinary-Today hero: they were never approved and did not match the approved website design. The owner then rejected both the direct paste of Vrat sweep `485:51` and the invented textile-bookplate composition as cross-archetype/source misunderstandings. Owner, 2026-08-19. | Keep the approved ordinary-Today layout and every content module frozen. Do not use the thin vertical edge, detached fragment, Vrat hero sweep, or removed bookplate nodes `675:14247`–`675:14253`. The exact historical twelve-treatment vocabulary is recovered at archive `682:22`; it is evidence/source inventory, not permission to paste one treatment into Today. Source candidate and 390px companion remain unchanged. | Today ordinary/no-hero panel · integrator |
...
| `GDF-056` | `PATTERN` · `ACTIVE` | The owner clarified that the intended source is the **approved elements within Ganak's ornament language and approved colours**, not a generic “design vocabulary” and not one universal floral asset. Evidenced families include powder-blue lattice, fine antique-gold framing, crimson punctuation, connected flowers/vines, transitions, ribbons and niches. The owner rejected treating `485:51` as the whole vocabulary or pasting it into unrelated screens. Owner, 2026-08-19. | Recover and cite the exact source element before composing again. Archive `682:22` remains `NOT APPROVED` evidence. Board `707:14247` defines the pending controlled-improvisation guardrail: vary motif/density/colour balance only within a named family and role; a genuinely new family or a source extraction in a new job returns to the owner. `485:51` remains Festival/Vrat hero-only unless the owner explicitly approves another use. | Website ornament system · integrator + all lanes |
...
| `GDF-060` | `PATTERN` · `APPROVED` | The nine transparent floral artworks in `743:16083` are good reusable Ganak vocabulary elements, but approval is per asset and role—not permission to use all at once or on every screen. Owner, 2026-08-19. | Instantiate shared floral set `760:20`. `760:21` and source `485:51` remain Festival/Vrat hero-only. Preserve edge growth and structural connection; prohibit detached stickers, meaningless cropped corners, clutter and universal paste. | Festival/Vrat floral vocabulary · integrator + Lane B |
| `GDF-061` | `GLOBAL` · `ACTIVE` | Owner visual-review cadence requires exactly twelve complete desktop-English primary screens in `OWNER REVIEW · BATCH 01 · 12-SCREEN QUALITY CHECKPOINT`: four Today/Panchang, four Festivals/Vrat and four Muhurat/Prashna. Responsive/HI are adjacent QA evidence, not extra owner decisions. Owner, 2026-08-19. | Queue only exact-node independent-QA passes. Keep blocked astronomy, limitations and QA prose outside screens. Owner answers only: overall Ganak feel, weakest screens, repeated mistake. | Batch 01 owner-review workflow · integrator + QA |
...
| Final Festival/Vrat visual-primary pair `535:7265`, `544:8016`; baseline-review clones `652:14035`, `652:14120` | `001–029`, `037–043`, `048`, `057` as applicable | Approved `485:24` botanical/deity composition remains unchanged and continuous at 390. The four-frame binding correction changed only confirmed dull-ivory drift to approved-safe bases; purposeful navy, crimson, gold and botanical roles remain. No Shashthi mark existed in either Festival/Vrat review clone. | Screenshot-level post-fix sanity check passed on 2026-08-19. This remains the current visual baseline for owner confirmation. **Production interaction FAIL:** Follow/Listen still use internal prototype outcomes and several shared destinations are not implemented production routes. |
