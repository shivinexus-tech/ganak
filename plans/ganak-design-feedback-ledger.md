...
| ID | Class / status | Owner feedback and source | Concrete do / don't | Scope / owner |
|---|---|---|---|---|
| `GDF-054` | `REJECTED DIRECTION` · `FIXED — OWNER REVIEW` | The owner explicitly rejected the minimal vertical floral edge and detached lower-right ornament used inside the current ordinary-Today hero: it was never approved and does not match the approved website design. The owner clarified that these fragments must be replaced, not merely removed. Owner, 2026-08-19. | Do not use the thin vertical edge or detached fragment as a Today-hero treatment. Replace them with the complete approved bright botanical sweep from vocabulary source `485:51`, kept fully visible as one coherent left/bottom structural composition. The old source/review fragments remain hidden at `601:9793`, `601:9795`, `628:13637`, `628:13639`, `652:13965`, `652:13967`, `652:13996`, `652:13998`; replacements are source `667:14247`, `667:14248` and review `666:14247`, `666:14248`. Keep all other Today content, geometry and styling frozen. | Today hero · Lane A + integrator |
...
| Final Today visual-primary pair `601:9563`, `601:8508`; owner-review clones `652:13737`, `652:13989` | `001–035`, `047–048`, `054–055` as applicable | Responsive shared lineage restored; approved Today modules retained; minimum text 12px; GOOD/AVOID semantics restored; final 390 labels measure 5.47:1; no overlap, overflow, QA-copy leakage or Phone/native lineage. The unapproved detached fragments are hidden and replaced in both active sources and both review clones by the complete approved bright botanical sweep from `485:51` (`667:14247`, `667:14248`, `666:14247`, `666:14248`). The desktop is the visual decision and 390 is QA evidence only. | **Visual-direction + accessibility PASS** by independent QA on 2026-08-19 before the targeted ornament correction; fresh post-change renders show the complete source-derived composition with no text collision or clipping. Ornament remains **OWNER REVIEW**. **Production interaction FAIL:** unsupported/unimplemented routes and unmapped/Figma-only destinations remain open under `009`, `011`, `025`, `047`. |
