...
| ID | Class / status | Owner feedback and source | Concrete do / don't | Scope / owner |
|---|---|---|---|---|
| `GDF-054` | `REJECTED DIRECTION` · `CLOSED` | The owner explicitly rejected the minimal vertical floral edge and lower flourish used inside the current ordinary-Today hero: it was never approved and does not match the approved website design. Owner, 2026-08-19. | Do not use the thin vertical floral edge or detached lower flourish as a Today-hero treatment. Keep the rest of the approved Today composition frozen unless separately requested. The active source and owner-review instances were hidden at `601:9793`, `601:9795`, `628:13637`, `628:13639`, `652:13965`, `652:13967`, `652:13996`, `652:13998`. | Today hero · Lane A + integrator |
...
| Final Today visual-primary pair `601:9563`, `601:8508`; owner-review clones `652:13737`, `652:13989` | `001–035`, `047–048`, `054–055` as applicable | Responsive shared lineage restored; approved Today modules retained; minimum text 12px; GOOD/AVOID semantics restored; final 390 labels measure 5.47:1; no overlap, overflow, QA-copy leakage or Phone/native lineage. The unapproved minimal floral edge/lower flourish is hidden in both active sources and both review clones; fresh desktop/390 renders are clean. The desktop is the visual decision and 390 is QA evidence only. | **Visual-direction + accessibility PASS** by independent QA on 2026-08-19 before the surgical ornament removal; post-change screenshots confirm no layout regression. Eligible for visual-only owner review. **Production interaction FAIL:** unsupported/unimplemented routes and unmapped/Figma-only destinations remain open under `009`, `011`, `025`, `047`. |
