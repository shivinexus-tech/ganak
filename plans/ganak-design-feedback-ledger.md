...
| ID | Class / status | Owner feedback and source | Concrete do / don't | Scope / owner |
|---|---|---|---|---|
| `GDF-054` | `REJECTED DIRECTION` · `CHANGES REQUESTED — DESKTOP OWNER REVIEW` | The owner explicitly rejected the minimal vertical floral edge and detached lower-right ornament used inside the current ordinary-Today hero: they were never approved and did not match the approved website design. The owner clarified that the two ornaments must be replaced, not merely removed. The subsequent direct paste of the complete Vrat botanical sweep `485:51` was also rejected as a mindless cross-archetype substitution. Owner, 2026-08-19. | Keep the approved ordinary-Today layout and every content module frozen. Do not use the thin vertical edge, detached fragment, or the Vrat hero sweep as the replacement. The desktop review frame `652:13737` now tests a job-specific textile-bookplate composition inside panel `652:13964`: lattice rail `675:14247` from vocabulary source `62:2`, gold rails `675:14248`/`675:14249`, floral terminal `675:14250` from `62:13`, and upper finials `675:14251`/`675:14253` from `148:323`/`148:325`. The rejected pasted sweep remains hidden at `666:14247`. Source candidate and 390px companion remain unchanged/pending until the owner accepts the desktop ornament. | Today ordinary/no-hero panel · integrator |
...
| `GDF-056` | `PATTERN` · `ACTIVE` | The original textile/card source is a design vocabulary, not one universal floral asset. It contains powder-blue lattice, fine antique-gold framing, crimson punctuation, leaf-vine/floral transitions, ribbons, niches and other elements. The owner rejected treating `485:51` as the whole vocabulary or pasting it into unrelated screens. Owner, 2026-08-19. | Select and compose vocabulary elements according to the screen's job. Preserve approved screen architecture; use ornament structurally as rail, frame, transition or terminal. `485:51` remains the approved Festival/Vrat botanical hero source only unless the owner explicitly approves another use. | Website ornament system · integrator + all lanes |
...
| Final Today visual-primary pair `601:9563`, `601:8508`; owner-review clones `652:13737`, `652:13989` | `001–035`, `047–048`, `054–056` as applicable | Responsive shared lineage restored; approved Today modules retained; minimum text 12px; GOOD/AVOID semantics restored; final 390 labels measure 5.47:1; no overlap, overflow, QA-copy leakage or Phone/native lineage. Ornament correction is deliberately desktop-first: `652:13737` preserves the approved ordinary/no-hero screen and replaces only the two disputed decorations with the textile-bookplate review nodes `675:14247`–`675:14253`. The direct Vrat-sweep paste `666:14247` is hidden/rejected. Source `601:9563` and 390px frames remain unchanged until desktop ornament approval. | **Visual-direction + accessibility PASS** by independent QA on 2026-08-19 before the targeted ornament correction. The new desktop ornament is **OWNER REVIEW** and has a same-size source/candidate visual comparison with no content movement, collision or clipping; it has not been propagated. **Production interaction FAIL:** unsupported/unimplemented routes and unmapped/Figma-only destinations remain open under `009`, `011`, `025`, `047`. |
