# Durga Puja — Dashami (Visarjan) — content profile

**Key:** `durgaPujaDashami` · **Route:** `/festival/durga-puja-dashami` · **Status:** P0 row #29 — generated profile (2026-07-24)

## One-line purpose

Dashami is Vijaya Dashami and Devi's loving farewell. Offer the final anjali, join sindoor khela where customary, accompany the visarjan procession and return home with Bijoya greetings.
