# Bhai Dooj — content profile

**Key:** `bhaiDooj` · **Route:** `/festival/bhai-dooj` · **Status:** P0 row #29 — generated profile (2026-07-24)

## One-line purpose

Perform the sibling tilak in the local Aparahna period, exchange blessings and share food. The relationship is reciprocal care; gifts are optional and no sibling should be excluded for gender or marit
